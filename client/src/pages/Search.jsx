...
export default function Search() {
  ...
  useEffect(() => {
    ...
    setSideBarData(prevData => ({
      ...
      sort: sortFromUrl || "createdAt",  // Cambié "createdAt" por "created_at"
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <select
              ...
              onChange={handleChange}
              defaultValue={"createdAt_desc"}  // Cambié a "created_at_desc"
            >
              <option value="regularPrice_desc">Price high to low</option>
              <option value="regularPrice_asc">Price low to high</option>
              <option value="createdAt_desc">Latest</option>  {/* Cambié "createdAt" por "created_at" */}
              <option value="createdAt_asc">Oldest</option>  {/* Cambié "createdAt" por "created_at" */}
            </select>
          </div>
